...
<div class="questions index">
	...
	<div style='color:red; height:20px'> <?php echo $this->Session->flash(); ?> </div>
		...
		<div class='module_title' style='margin: 40px 0 20px 10px;'>
			...
			<span class='black_box' >
				<a href="/petgurustage/questions/add" style='position:relative; top:-10px'>Add new</a>
			</span>
		</div>
	...
	<tr >
		...
		<td title='<?php echo $question['Question']['question_name']?>' class='wrapped_td'> <div class='td_span'>
			<?php 
				echo substr ($question['Question']['question_name'], 0, 50); 
				if ( strlen( $question['Question']['question_name'] ) >= 50 ) echo ". . . . .";
			?> 
			</div>
		</td>		
		<td>
