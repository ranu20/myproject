	...
	function imagePreview(input) {
		...
		if (input.files && input.files[0]) {
			...
			if( $.browser.msie || $.browser.safari){
				...
				$("#cur_image").css({'border':'2px solid #ccc','height':'110px','width':'110px','font-size':'12px'});
				...
				$("#new_image").css({'border':'2px solid #ccc','height':'110px','width':'110px','font-size':'12px'});
			}			
		}
...
<?php echo $this->Form->create('Product', array('type'=>'file','onSubmit'=>'return validate_form()')); ?>	
	...
	<div class='module_title' style='margin-top:45px'>
		<fieldset>
				...
				<div id='cur_image' style='border:2px solid #ccc; height:115px; width:115px'>
					<?php
						if ( $this->data['Product']['product_image_url'] && is_file (  IMAGES . "products/". $this->data['Product']['product_image_url']) )
							...
							echo ($this->Html->image( 'no_image.png',array('border'=>0,'width'=>'115','height'=>'115'))) ;
					?>
				</div>
				<div id='new_image'>	
			...
			<div style='float: left; width: 84px; margin-left: 10px; height: 40px; padding-top: 75px;'>				
			...
			<div class="float" style='width:68%; margin-left:10px;' class='spc_dd'>
				...
				<div style='float:left' id='special_dropdown' class='spc_dd'>	<img src='/petgurustage/img/drop_down.png' class='spc_dd'>	</div>
