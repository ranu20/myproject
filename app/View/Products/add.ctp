...
<style>
.chicken_input {
	float:left; width:20px; line-height:18px; height:20px; width:100px; margin-top: 10px!important;
}

.puppy_label{
	float:left; width:20px; line-height:18px; height:20px; width:90px; margin-top: 10px!important;
}
...
<script>	
	$(document).ready(function(){
		...
		$('.dashboard').css({'min-height':'800px'});
			...
			<fieldset>
				...
				<div class="float" style='width:100%; height:40px'>
					<div style='float:left; width: 66%;line-height:70px' >
						<div class='form_field_title' style='margin-left: 0px; float:left; width: 100px;line-height:15px'> 
							<?php echo __('Chicken'); ?>
						</div>
						<div class='chicken_input'> 
							<input type='checkbox' name='data[Product][chicken]'  id='DataProductChicken'>  
						</div>

						<div class='puppy_label'> 
							<?php echo __('Puppy'); ?>	
						</div>
						
						<div class='puppy'> 
							<input type='checkbox' name='data[Product][puppy]'  id='DataProductPuppy'>  
						</div>
				...
				<div class="float" style='width:100%; height:80px'>
				...
				<div style='height:100px' style='width:100%;'>
						...
						<div class="float" style='width:86%; height:100px'>	
							<div>
								<div style='float:left; width:540px'> <input type='text' disabled id='txt_category'> </div>							
								<div style='float:left' id='special_dropdown_category'> <?php echo $this->Html->image('drop_down.png')?> </div>
							</div>
							
							<div style='clear:both'> </div>
							
							<div id='special_dropdown_category_target' style='height:100px; border:1px solid #ccc; overflow-y:scroll;width:562px;position:relative; top:-4px'>
				...
				<div class="float" style='width:67%' id='special_dropdown_container'>					
					...
					<div id='special_dropdown_target' style='height:135px; border:1px solid #ccc; overflow-y:scroll; width:99%;position:relative; top:-4px' class='spc_dd'>
