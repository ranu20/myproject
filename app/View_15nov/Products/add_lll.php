	...
	<?php echo $this->Form->create('Product', array('type'=>'file', 'onSubmit'=>'return validate_form()')); ?>
		...
		<div class='module_title'>
			<fieldset>
				...
				<div style="display: block; width: 130px; height: 50px; overflow: hidden;">
					<button style="width: 100px; height: 40px; position: relative; top: -5px; left: -5px; background-color:#424242; color:white"> Upload File </button>
					<input type="file" id="product_image" name="data[Product][product_image]" style="font-size: 50px; width: 120px; opacity: 0; filter:alpha(opacity: 0);  position: relative; top: -40px;; left: -20px" onchange='imagePreview(this)' />
				</div> -->	
