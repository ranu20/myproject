...
<?php echo $this->Form->create('QuestionAttribute'); ?>
	<fieldset>
		<legend><?php echo __('Edit Question Attribute'); ?></legend>
	<?php
		echo $this->Form->input('question_attribute_id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QuestionAttribute.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('QuestionAttribute.id'))); ?></li>
