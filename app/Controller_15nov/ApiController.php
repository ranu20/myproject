...
App::uses('AppController', 'Controller');
	...
	public $uses = array('Attribute','AttributeProduct','AttributeQuestion','Brand','Category', 'CategoryQuestion','Product','Question','MaxWeightage');
		...
		public function api() {
			...
			// ATTRIBUTE DATA
			$params_attr	= array('fields'=>array('attribute_id','attribute_name','weight','question_id','status','updated_date'), 'recursive'=>-1);
			...
			// PRODUCTS DATA
			$params_prd			= array('fields'=>array('product_id','product_name', 'product_image_url', 'brand_id', 'status','updated_date'), 'recursive'=>-1);
			...
			// QUESTIONS DATA			
			$params_questions	= array('fields'=>array('question_id','question_name', 'question_type', 'category_id', 'status','updated_date'), 'recursive'=>0);	
			if ( $conditions )
